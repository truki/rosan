...
'Introduce un valor entre 0 y 9999999, el signo de los decimales es el .': 'Introduce un valor entre 0 y 9999999, el signo de los decimales es el .',
'Introduce un valor entre 1 y 999999': 'Introduce un valor entre 1 y 999999',
'Introduce una descripción en el concepto': 'Introduce una descripción en el concepto',
